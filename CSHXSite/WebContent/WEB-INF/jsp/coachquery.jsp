...
<title>班次查询</title>
<script src="${ ctx}/thirdparty/jq-easyui/jquery.min.js" type="text/javascript"></script>
<script src="${ ctx}/thirdparty/jq-easyui/jquery.easyui.min.js" type="text/javascript"></script>
<script src="${ ctx}/thirdparty/jq-easyui/jquery.easing.1.3.js" type="text/javascript"></script>
<link href="${ ctx}/thirdparty/jq-easyui/themes/default/easyui.css" rel="stylesheet" type="text/css" />
<link href="${ ctx}/thirdparty/jq-easyui/themes/icon.css" rel="stylesheet" type="text/css" />
<script src="${ ctx}/thirdparty/jq-easyui/locale/easyui-lang-zh_CN.js" type="text/javascript"></script>
<script src="${ ctx}/thirdparty/slideViewer/slideViewer.js" type="text/javascript"></script>
<link href="${ ctx}/thirdparty/slideViewer/style/slideViewer.css" rel="stylesheet" type="text/css" />
  ...
  <div class="divk">
    <table width="100%" height="72" border="0" cellpadding="0" cellspacing="0">
      ...
      <tr>
        ...
        <li class="header-function-text"><a class="header-function-link"  href="${ ctx}/more/morenews.html">新闻公告</a></li>
        <li class="header-function-image"></li>
        <li class="header-function-text"><a class="header-function-link"  href="${ ctx}/coachquery">班次查询</a></li>
        <li class="header-function-image"></li>
...
<div class="divk">
  <div class="xwgg-kr">
    ...
    <table width="392" height="254" border="0" align="center" cellpadding="0" cellspacing="0">
      ...
      <form id="form1" name="form1" method="post" action="${ctx}/coachinfo">
